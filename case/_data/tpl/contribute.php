...
<!-- End Google Tag Manager -->
	...
	<meta name="format-detection" content="telephone=no" />
         <title><?php echo $title; ?>｜施工事例｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
	<?php
	if($meta_keyword_Value){
?>
		<meta property="keywords" content="<?php echo $meta_keyword_Value; ?>" />
		<?php
	}else{
?>
			<meta name="keywords" content="施工事例,新築,一戸建て" />
	<?php
	}
?>
	<?php
...
?>
		<meta property="description" content="<?php echo $meta_description_Value; ?>" />
		<?php
	}else{
?>
			<meta name="description" content="三重県の平安コーポレーションの豊富な<?php echo $title; ?>を一覧でご紹介します。当社の住宅は、耐震性能や気密性、断熱性、デザイン性に優れています。詳細は画像をクリックして表示。" />
	<?php
	}
?>
	...
	<!-- Google Analytics start -->
			    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 2,
                "item": {
                    "@id": "https://www.citylights.estate/case/",
                    "name": "施工事例（一覧）"
                }
            },
			{
                    ...
                    "position": 3,
                    "item": {
                        "@id": "https://www.citylights.estate/case/<?php echo $current_category_url; ?>",
                ...
                },
				{
                    ...
                    "position": 4,
                    "item": {
                        "@id": "https://www.citylights.estate/case/<?php echo $url; ?>",
                        "name": "<?php echo $title; ?>"
                    }
                }
			]
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
        <header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../../images/site_logo.svg" alt="<?php echo $title; ?>｜三重の工務店、平安コーポレーションが手がけた注文住宅の施工事例" width="344" height="35"></a></h1>
		...
		<!-- end <header>-->
		<main class="uInfo-detail">
			<div id="top_info" class="case-blog">
                <div class="inner">
                    <div class="udr-box-h2">
                        <h2 class="udr-h2-jp"><?php echo $title; ?></h2>
                        <p class="udr-h2-en">CASE</p>
                    </div>
                </div>
            </div>
            <!-- #top_info end -->
            ...
            <div id="content">
                <div class="inner">
<section class="udr-section-h3 udr-section-h3-blog">
						<p class="udr-name-cate"><?php echo $current_category_name; ?></p>
                    <div class="udr-box-h3">
                            <p class="udr-h3-en">CASE</p>
                            <h3 class="udr-h3-jp"><?php echo $title; ?></h3>
                        </div>
						<p class="txt">地域密着の工務店、「平安コーポレーション」が手がけた施工事例の詳細と、お客様から頂戴した喜びの声をご紹介します。
						</p>
						<p class="txt">
三重県や奈良県を中心に、注文住宅や新築一戸建てをご提供している平安コーポレーションでは、高性能でデザイン性に優れた注文住宅を、理想の予算内でご提供しています。当社の誇るデザイン性と機能性の高い注文住宅をすみずみまでご確認ください。
</p>
                        </section>
						<?php
	if($img01_Value || $img02_Value || $img03_Value || $img04_Value || $img05_Value || $img06_Value || $img07_Value || $img08_Value || $img09_Value || $img010_Value){
?>
                    <section>
					<div class="ud-fx-land">
					                        <div class="ud-thumb-list">
                            <ul class="ud-img-galley">
                                <?php
                                for ($i = 0; $i <= 20; $i++) :
                                    $imgValue = 'img0' . $i . '_Value';
                                    $imgSrc = 'img0' . $i . '_Src';
                                    $textValue = 'txt0' . $i . '_Value';
                                ?>
                                <?php if ($$imgValue || $$textValue) : ?>
                                <?php if ($$imgValue) : ?>
                                <li><img src="<?php echo $$imgSrc ?>" alt="<?php echo $title; ?>"></li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php
                                endfor;
                        ...
                        <div class="ud-thumb-show">
                            <ul class="ud-img-show">
                                <?php
                                for ($i = 0; $i <= 20; $i++) :
                                    $imgValue = 'img0' . $i . '_Value';
                                    $imgSrc = 'img0' . $i . '_Src';
                                ...
                                <?php if ($$imgValue || $$textValue) : ?>
                                <?php if ($$imgValue) : ?>
                                <li><p class="img"><img src="<?php echo $$imgSrc ?>" alt="<?php echo $title; ?>"> <?php if ($$textValue) : ?><span class="txt-comment"><?php echo $$textValue ?></span><?php endif; ?></p></li>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php
                                endfor;
...
?>        
<?php
	if($img021_Value || $txt021_Value){
?>
                      <section>
					  <?php
	if($img021_Value){
?>
							<div class="img-cen uImg-w1000">
								<img src="<?php echo $img021_Src; ?>" alt="<?php echo $title; ?>">
							</div>
							<?php
	}
?>
	...
	if($txt021_Value){
?>
								<div class="uInfo-desc">
									<?php echo $txt021_Value; ?>
								</div>
							<?php
	}
?>
...
?>
					...
					<ul class="btn_prev_next">
						<?php if ($prev = @$pages[$current_page + 1]) : ?>
							<li class="prevPage">
								<a href="../<?php echo $prev ?>" class="ubtn prev"><span>前の記事へ</span></a>
							</li>
						<?php endif; ?>
						<li class="mid"><a href="../" class="ubtn mid">一覧へ</a></li>
						<?php if ($next = @$pages[$current_page - 1]) : ?>
							<li class="nextPage">
								<a href="../<?php echo $next ?>" class="ubtn next"><span>次の記事へ</span></a>
							</li>
						<?php endif ?>
					</ul>
                    </section>
