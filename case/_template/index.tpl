...
<!-- End Google Tag Manager -->
	...
	<title>施工事例（一覧）｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
        <header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../images/site_logo.svg" alt="三重県の平安コーポレーションがご紹介している分譲地・土地情報の一覧です。" width="344" height="35"></a></h1>
		...
		<main>
            ...
            <div id="content">
				...
				<div class="udr-box-h3">
                            ...
                            <h3 class="udr-h3-jp">平安コーポレーションの施工事例</h3>
                        </div>
										<p class="txt">
