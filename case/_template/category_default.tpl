...
<!-- End Google Tag Manager -->
	...
	<meta name="format-detection" content="telephone=no" />
         <title>{=$current_category_name=}｜施工事例（一覧）｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
	...
	<ONIf condition="$meta_description_Value">
		...
		<ONElse>
			<meta name="description" content="三重県の平安コーポレーションの豊富な{=$current_category_name=}を一覧でご紹介します。当社の住宅は、耐震性能や気密性、断熱性、デザイン性に優れています。詳細は画像をクリックして表示。" />
	</ONIf>
	...
	<link rel="stylesheet" media="all" href="../../css/under_responsive.css" />
		    <script type="application/ld+json">
        {
            ...
            },
			{
                    ...
                    "position": 3,
                    "item": {
                        "@id": "https://www.citylights.estate/case/{=$current_category_url=}",
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
        <header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../../images/site_logo.svg" alt="三重県の平安コーポレーションの豊富な{=$current_category_name=}を一覧でご紹介します。" width="344" height="35"></a></h1>
		...
		<main>
			<div id="top_info" class="case-blog">
                <div class="inner">
                    <div class="udr-box-h2">
                        <h2 class="udr-h2-jp">{=$current_category_name=}</h2>
            ...
            <div id="content">
				...
				<div class="udr-box-h3">
                            ...
                            <h3 class="udr-h3-jp">{=$current_category_name=}</h3>
                        </div>
										<p class="txt">
				三重県で理想とする注文住宅や新築一戸建てを建てたいお客様は、「平安コーポレーション」にご相談ください。こちらでは、当社の豊富な施工事例を一覧でご紹介します。
	</p>
	<p class="txt">
当社では、耐震性能や気密性、断熱性に優れているのはもちろん、デザイン性にも優れているお住まいをご提供しています。詳細につきましては、当社が主催する見学会などのイベントでお確かめください。
</p>
<p class="txt">
施工事例の詳細は、画像をクリックするとご覧いただけます。
</p>
				</section>
 ...
 <section>
                    ...
                    <section>
                        <ul class="udr-list-info udr-list-land">
                        <?php $limitNum = 9 ?>
						<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="@$current_category_id">
							<ONContributeFetch>
								<?php
								$arrImg = ["img01", "img02", "img03", "img04", "img05", "img06", "img07", "img08", "img09", "img010", "img011", "img012", "img013", "img014", "img015", "img016", "img017", "img018", "img019", "img020", "img021"];
								...
								<li>
									...
									<p class="img">
										...
										<?php else : ?>
										<img src="../../images/udr-dummy.jpg" alt="{=$title=}">
										<?php endif; ?>
										<span class="cate-land">{=$category_name=}</span>
									</p>
                                    <p class="cnt">
									<span class="udr-fx-cate">
									<label class="address">{=$txt_address_Value=}</label>
									<label class="name">{=$txt_name_Value=}</label>
									</span>
