...
<!-- End Google Tag Manager -->
    ...
    <title>資料請求｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
    <meta name="keywords" content="資料,新築,建築,設計">
    <meta name="description" content="平安コーポレーションの家づくりに興味を持たれた方、こちらから資料請求をお願いします。当社なら高性能でデザイン性に優れた注文住宅を、理想の予算内で建てられます。">
    <!-- FAVICON -->
    ...
    <link rel="stylesheet" href="../css/responsive.css">
            <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 2,
                "item": {
                    "@id": "https://www.citylights.estate/document/",
                    "name": "資料請求"
                }
            }]
        }
...
<!-- End Google Tag Manager (noscript) -->
    <div id="wrapper">
        <header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../images/site_logo.svg" alt="平安コーポレーションの家づくりに興味を持たれた方、こちらから資料請求をお願いします。" width="344" height="35"></a></h1>
         ...
         <div id="top_info" class="contact">
                <div class="inner">
                    <div class="udr-box-h2">
                        <h2 class="udr-h2-jp">資料請求</h2>
                        <p class="udr-h2-en">DOCUMENT</p>
                    </div>
                </div>
            </div>
            <!-- #top_info end -->
            ...
            <section class="udr-section-h3">
                        <div class="udr-box-h3">
                            <p class="udr-h3-en">DOCUMENT</p>
                            <h3 class="udr-h3-jp">家づくりの資料のご請求はこちらから</h3>
                        </div>
                        <p class="txt">「機能もデザインもどちらもこだわった家づくりをしたい」「予算内で理想の家を建てたい」「土地探しから相談したい」・・・など、「平安コーポレーション」の家づくりに興味を持たれた方、まずはお気軽に資料請求をお願いします。
                        </p>
                        <p class="txt">
平安コーポレーションなら、高性能でデザイン性に優れた注文住宅を、お客様の理想の予算内で建てることが可能です。家づくりを考え始めたばかりの方も、お気軽にお問い合わせください。
</p>
                    </section>
                    <section id="fmail_form">
                        <h4 class="udr-h4">資料請求</h4>
