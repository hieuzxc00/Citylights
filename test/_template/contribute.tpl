            ...
            <div id="top_info" class="case-blog">
                <div class="inner">
                    <div class="udr-box-h2">
                        ...
                        <p class="udr-h2-en">Single Test</p>
                    </div>
                </div>
            </div>
            <!-- #top_info end -->
            ...
            <div id="content">
                <div class="inner">
                    ...
                    <section class="clearfix">
                        ...
                        <p class="mb30">{=$text02_Value=}</p>
                        </ONIf>

                        <ONIf condition="$radio1_Value">
                        <ul class="list01">
                            <li>{=$radio1_Value=}</li>
                        </ul>
                        </ONIf>

                        <ONIf condition="$check1_Value">
                            <ul>
                                <li>{=$check1_Value=}</li>
                            </ul>
                        </ONIf>

                        <ONIf condition="$select_Value">
                            <ul>
                                <li>{=$select_Value=}</li>
                            </ul>
                        </ONIf>
                        ...
                        <p class="center ovn_img"><img src="{=$img01_Src=}" alt="{=$title=}"></p>
                        <p class="center">will show when Value = true</p>
                        </ONIf>

                        <p class="f_center"><a class="btn btn-secondary my-2" href="../../{=$category_url=}/">一覧に戻る</a></p>
                    </section>
                </div>
            </div>
