...
<!-- End Google Tag Manager -->
	...
	<title><?php echo $title; ?>｜お知らせ・スタッフブログ・イベント情報｜三重県で理想の注文住宅｜平安コーポレーション</title>
	<?php
...
?>
			<meta name="keywords" content="お知らせ,ブログ,イベント情報" />
	<?php
	}
?>
	<?php
...
?>
			<meta name="description" content="三重の住宅会社、平安コーポレーションからのお知らせです。イベント情報や新しい設備のご紹介、アフターメンテナスの状況などを随時掲載しています。スタッフによるブログも更新中。" />
	<?php
	}
?>
	...
	<!-- Google Analytics start -->
		    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 2,
                "item": {
                    "@id": "https://www.citylights.estate/info/",
                    "name": "お知らせ"
                }
            },{
                "@type": "ListItem",
                "position": 3,
                "item": {
                    "@id": "https://www.citylights.estate/info/<?php echo $current_category_url; ?>",
            ...
            },
			{
                ...
                "position": 4,
                "item": {
                    "@id": "https://www.citylights.estate/info/<?php echo $url; ?>",
                    "name": "<?php echo $title; ?>"
                }
            }]
        }
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
		<header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../../images/site_logo.svg" alt="三重の住宅会社、平安コーポレーションからのお知らせ、イベント情報、ブログです。" width="344" height="35"></a></h1>
            ...
            <div id="topic_path">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../">お知らせ・スタッフブログ・イベント情報</a></li>
