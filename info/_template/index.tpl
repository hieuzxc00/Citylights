...
<!-- End Google Tag Manager -->
	...
	<title>お知らせ・スタッフブログ・イベント情報｜三重県で理想の注文住宅｜平安コーポレーション</title>
	<meta name="keywords" content="お知らせ,ブログ,イベント情報" />
	<meta name="description"
		content="三重の住宅会社、平安コーポレーションからのお知らせです。イベント情報や新しい設備のご紹介、アフターメンテナスの状況などを随時掲載しています。スタッフによるブログも更新中。" />
			...
			<div id="top_info" class="info-blog">
                <div class="inner">
                    <div class="udr-box-h2">
                        <h2 class="udr-h2-jp">お知らせ・スタッフブログ・イベント情報</h2>
