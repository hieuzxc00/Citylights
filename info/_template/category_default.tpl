...
<!-- End Google Tag Manager -->
	...
	<title>{=$current_category_name=}｜お知らせ・スタッフブログ・イベント情報｜三重県で理想の注文住宅｜平安コーポレーション</title>
		...
		<main>
            ...
            <div id="content">
				...
				<div class="udr-box-h3">
                            ...
                            <h3 class="udr-h3-jp">平安コーポレーションからのお知らせ</h3>
                        </div>
										<p class="txt">三重県や奈良県のお客様に理想の注文住宅や・新築一戸建てをご提供している「平安コーポレーション」からのお知らせです。イベント情報や新しい設備のご紹介、アフターメンテナスの状況などを随時掲載しています。
    </p>
    <p class="txt">
当社スタッフによる、お住まいに関するブログも更新中。住まいづくりについて読んで得する情報が満載です。「建てて終わりではなく、お客様と末永くお付き合いしたい」という私たちの想いを知っていただければ幸いです。
</p>
				</section>
                 <section>
						...
						<ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="@$current_category_id">
							<ONContributeFetch>
								...
								<li>
                                    ...
                                    <p class="cnt">
                                     <span class="date"><?php echo date("Y.m.d", strtotime($date)); ?></span>
