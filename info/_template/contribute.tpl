...
<!-- End Google Tag Manager -->
	...
	<title>{=$title=}｜お知らせ・スタッフブログ・イベント情報｜三重県で理想の注文住宅｜平安コーポレーション</title>
	...
	<!-- Google Analytics start -->
		    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 3,
                "item": {
                    "@id": "https://www.citylights.estate/info/{=$current_category_url=}",
            ...
            },
			{
                ...
                "position": 4,
                "item": {
                    "@id": "https://www.citylights.estate/info/{=$url=}",
                    "name": "{=$title=}"
                }
            }]
        }
