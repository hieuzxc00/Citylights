...
<!-- End Google Tag Manager -->
	...
	<meta name="format-detection" content="telephone=no" />
     <title><?php echo $title; ?>｜土地・分譲地情報｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
    <?php
   			    ...
   			    <script type="application/ld+json">
        {
            ...
            },
			{
                ...
                },
                 {
                    ...
                    "position": 4,
                    "item": {
                        "@id": "https://www.citylights.estate/land/<?php echo $url; ?>",
                        "name": "<?php echo $title; ?>"
                    }
                }
			]
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
		<header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../../images/site_logo.svg" alt="<?php echo $title; ?>｜三重の工務店、平安コーポレーションがご提供する土地・分譲地情報" width="344" height="35"></a></h1>
            ...
            <div id="topic_path">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../<?php echo $category_url; ?>"><?php echo $current_category_name; ?></a></li>
					...
					?>
                      <div class="section">
							<div class="img-cen uImg-w1000">
								<img src="<?php echo $blogImgSrc; ?>" alt="<?php echo $title; ?>">
							</div>
							<?php
	if($blogText){
?>
