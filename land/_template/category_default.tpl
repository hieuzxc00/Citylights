...
<!-- End Google Tag Manager -->
 ...
 <title>{=$current_category_name=}｜土地・分譲地情報（一覧）｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
    <meta name="keywords" content="{=$current_category_name=},土地,分譲地,土地探し" />
    <meta name="description"
        content="{=$current_category_name=} | 三重県や奈良県で注文住宅をお届けする、平安コーポレーションは土地探しからお手伝いさせていただきます。当社がご紹介している分譲地・土地情報の一覧です。" />
