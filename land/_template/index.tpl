...
<!-- End Google Tag Manager -->
	...
	<title>土地・分譲地情報（一覧）｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
	<meta name="keywords" content="土地,分譲地,土地探し" />
	<meta name="description" content="三重県や奈良県で注文住宅をお届けする、平安コーポレーションは土地探しからお手伝いさせていただきます。当社がご紹介している分譲地・土地情報の一覧です。" />
		...
		<main>
			<div id="top_info" class="land-blog">
                <div class="inner">
                    <div class="udr-box-h2">
                        <h2 class="udr-h2-jp">土地・分譲地情報（一覧）</h2>
            ...
            <div id="content">
				...
				<div class="udr-box-h3">
                            ...
                            <h3 class="udr-h3-jp">土地・分譲地情報</h3>
                        </div>
						...
						<ONContributeSearch page="@$_GET['p']" limit="$limitNum">
							<ONContributeFetch>
								...
								<li>
									...
									<label class="cate">{=$category_name=}</label>
