...
<!-- End Google Tag Manager -->
	...
	<meta name="format-detection" content="telephone=no" />
     <title>{=$title=}｜土地・分譲地情報｜三重県で理想の注文住宅を実現｜平安コーポレーション</title>
    <ONIf condition="$meta_keyword_Value">
		<meta property="keywords" content="{=$meta_keyword_Value=}" />
		<ONElse>
			<meta name="keywords" content="施工事例,新築,一戸建て" />
	</ONIf>
   <ONIf condition="$meta_description_Value">
		<meta property="description" content="{=$meta_description_Value=}" />
		<ONElse>
			<meta name="description" content="三重県の平安コーポレーションの豊富な施工事例を一覧でご紹介します。当社の住宅は、耐震性能や気密性、断熱性、デザイン性に優れています。詳細は画像をクリックして表示。" />
	</ONIf>
	...
	<!-- Google Analytics start -->
   			    <script type="application/ld+json">
        {
            ...
            },
			{
                    ...
                    "position": 3,
                    "item": {
                        "@id": "https://www.citylights.estate/land/{=$current_category_url=}",
                ...
                },
                 {
                    ...
                    "position": 4,
                    "item": {
                        "@id": "https://www.citylights.estate/land/{=$url=}",
                        "name": "{=$title=}"
                    }
                }
			]
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrapper">
		<header class="header">
            <h1 class="header__logo"><a href="https://www.citylights.estate/"><img src="../../images/site_logo.svg" alt="{=$title=}｜三重の工務店、平安コーポレーションがご提供する土地・分譲地情報" width="344" height="35"></a></h1>
            ...
            <div id="topic_path">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../{=$category_url=}">{=$current_category_name=}</a></li>
                        <li>{=$title=}</li>
                    </ul>
                </div>
            </div>
...
<section class="udr-section-h3 udr-section-h3-blog">
						<p class="udr-name-cate">{=$current_category_name=}</p>
                    <div class="udr-box-h3">
                            <p class="udr-h3-en">LAND</p>
                            <h3 class="udr-h3-jp">{=$title=}</h3>
                        </div>
						<p class="txt">三重県や奈良県での注文住宅は、地元密着の「平安コーポレーション」にお任せください。こちらでは、当社がご紹介している分譲地・土地情報について詳しくお伝えします。
						</p>
						<p class="txt">
三重県や奈良県を中心に、注文住宅や新築一戸建てをご提供している平安コーポレーションは、高性能でデザイン性に優れた注文住宅を、理想の予算内でご提供している工務店です。お客様の土地探しについては、お気軽にお問い合わせください。
</p>
                        </section>
						<?php
							$checkTable = false;
							for ($i=1; $i <= 8; $i++)  {
								if(!empty(${'tbl0' . $i . '_Value'})){
									$checkTable = true;
									break;
								}
							}
							if($checkTable):
							?>
							<section class="uInfo-detail">
							<div class="udr-tbl udr-tbl-bl">
									<table>
										<?php
											for ($i=1; $i <= 3; $i++):
											if(!empty(${'tbl0' . $i . '_Value'})):
										?>
											<tr>
												<th  class="bg">
                                                <?php echo ${'tbl0' . $i . '_Name'};?>
												</th>
												<td><?php echo ${'tbl0' . $i . '_Value'};?></td>
											</tr>
										<?php endif; endfor;?>
									</table>
									</div>
					...
					<?php
					for ($i = 1; $i <= 10; $i++) :
						if (!empty(${'img0' . $i . '_Value'}) || !empty(${'txt' . $i . '_Value'})) :
							$blogImg = ${'img0' . $i . '_Value'};
							$blogImgSrc = ${'img0' . $i . '_Src'};
							$blogText = ${'txt0' . $i . '_Value'};
					?>
                      <div class="section">
							<div class="img-cen uImg-w1000">
								<img src="{=$blogImgSrc=}" alt="{=$title=}">
							</div>
							<ONIf condition="$blogText">
				...
				<section>
					<ul class="udr-list-anchor udr-list-bnr col01 mb30">
                            <li>
                                <a href="../../case/">三重県で理想の注文住宅や・新築一戸建てを建てるなら<br>
平安コーポレーションにお任せください<br>
豊富な施工事例とお客様から頂戴した声はこちらから
</a>
                            </li>
                        </ul>
					</section>
